...
public class GameTwo {
    ...
    public static final int mTimeToWait = 1000;
    ...
    public GameTwo(ResultsCallback results, int size, int depth) {
...
/*
    ...
    public void botMove(int y, int x) {
        ...
        currentActiveNumb = y; //по ходу бота определим, где теперь будет строка
    }
    ...
    protected void activateRawOrColumn(final boolean active) {
        ...
        /*for (int i = 0; i < mMatrix.length/2; i++) {
            for (int j = 0; j < mMatrix.length/2; j++) {
                mResults.changeButtonClickable(i, j, false); //деактивируем
            }
        }*/
        int y, x;
