...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            deep = getIntent().getExtras().getInt("deep");
        ...
        game = new Game(this, MATRIX_SIZE, 3); //создаем класс игры
    ...
    public void onResult(int playerOnePoints, int playerTwoPoints) {
        ...
        if (playerOnePoints > playerTwoPoints){
            ...
            text = "ничья";
            Intent intent = new Intent(MainActivity.this, StandoffActivity.class);
            startActivity(intent);
            finish();
        }
